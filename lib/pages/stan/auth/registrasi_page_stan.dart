...
class RegistrasiPageStan extends StatefulWidget {
  const RegistrasiPageStan({super.key});

  @override
  State<RegistrasiPageStan> createState() => _RegistrasiPageStanState();
}

class _RegistrasiPageStanState extends State<RegistrasiPageStan> {
  @override
